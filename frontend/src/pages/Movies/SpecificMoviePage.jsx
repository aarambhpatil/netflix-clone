...
const SpecificMoviePage = () => {
  ...
  const recommendationUrl = `https://api.themoviedb.org/3/movie/${id}/recommendations?language=en-US&page=1`;
          ...
          <div className="flex-1">
            <ul className="text-gray-300 space-y-3">
              ...
              <li>
                ...
                <span className="ml-2">
                  {movie.budget ? `$${movie.budget.toLocaleString()}` : "NA"}
                </span>
              </li>
              <li>
                <span className="font-semibold text-white">Revenue: </span>
                <span className="ml-2">
                  {movie.budget ? `$${movie.revenue.toLocaleString()}` : "NA"}
                </span>
              </li>
              <li>
                <span className="font-semibold text-white">
